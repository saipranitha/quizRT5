...
// <<<<<<< HEAD
angular.module('quizRT', ['ngRoute', 'ngCookies','n3-pie-chart'])
// =======
// angular.module('quizRT', ['ngRoute', 'ngCookies','n3-line-chart'])
// >>>>>>> b8f73a465bdffda03c4686fadcd9654073b530ad
    ...
    .factory('socket', function ($rootScope) {
      ...
      //   var socket = io.connect('http://192.168.56.1:8000' + type, {'forceNew':true } );
        var socket = io.connect('http://172.23.238.170:8000' + type, {'forceNew':true } );
     ...
     .config(function($routeProvider){
       $routeProvider
        ...
        .when('/search',{
          'templateUrl': 'html/searchaUser.html',
          'controller': 'categoriesController'
        })
