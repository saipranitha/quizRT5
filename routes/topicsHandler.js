...
var express = require('express'),
   ...
   {
      console.log("hii total point"+(points/totalGames));
        ...
        if(err) {
          ...
          for(var i = 0; i < len; ++i ) {
            ...
            //   topicWithUserStats.userStats.topicRanks = topicsPlayed[i].ranks;
                 ...
                 topicWithUserStats.userStats.progressData = [
                                {label: "level", value: topicWithUserStats.userStats.levelPercentage, color: "green", suffix: "%"}
                              ];
                   topicWithUserStats.userStats.dataOptions  = {thickness: 10};
                    topicWithUserStats.userStats.graphOptions = [
                                                           {label: "WON", value: topicWithUserStats.userStats.topicWins , color: "#1f77b4"},
                                                           {label: "LOSE", value: topicWithUserStats.userStats.topicLosses , color: "#ff7f0e"},
                                                         ];
              break;
            }
          }
